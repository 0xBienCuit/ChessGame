...
import gameapplication.model.chess.ChessUtils;
import gameapplication.model.chess.PawnCaptureMove;
import gameapplication.model.chess.PromotionMove;
...
public class NetworkedChessController extends ChessController {
    ...
    public void makeMove(Move possibleMove) throws IllegalMoveException {
        ...
        super.makeMove(possibleMove); //move piece in the application.model, invokes the call back
