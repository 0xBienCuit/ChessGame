...
public class ChessController implements GameController {
    ...
    private final List<BiConsumer<Move, List<Position>>> moveCallbacks;
    private final List<Consumer<GameState>> stateCallbacks;
    private final List<Consumer<Side>> sideCallbacks;
